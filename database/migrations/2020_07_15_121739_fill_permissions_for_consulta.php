...
class FillPermissionsForConsulta extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConsulta constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.consulta',
            'admin.consulta.index',
            'admin.consulta.create',
            'admin.consulta.show',
            'admin.consulta.edit',
            'admin.consulta.delete',
            'admin.consulta.bulk-delete',
        ]);
